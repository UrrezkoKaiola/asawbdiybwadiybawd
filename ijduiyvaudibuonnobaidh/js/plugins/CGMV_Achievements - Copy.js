 ...
 *
 * Version 1.8:
 * - Bugfix for sound effect in a toast coming from the right side
 *
...
CGMV_Core.prototype.initializeAchievements = function(reinitialize) {
    ...
    // 101
    var achievements = new String(JsonEx.parse());
...
CGMV_Achievement_Window_Display.prototype.refresh = function() {
	...
	var genericGaugeColor2 = this.textColor(CGMV.Achievements.GenericGaugeColor2);
	// Draw criteria
